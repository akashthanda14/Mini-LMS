 ...
 */
router.get('/enrollments/:id/certificate', ensureAuth, getEnrollmentCertificate);
 ...
 * @access  Private (must own enrollment)
 */
router.get('/enrollments/:id/certificate/download', ensureAuth, downloadCertificatePDF);
